...
const ParentDashboard = () => {
  ...
  // Fetch ONLY parent's own children
  ...
  // Fetch recent attendance for parent's children only
  ...
  // Fetch messages for parent only
        ...
        <div className="space-y-6">
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-muted-foreground">Manage your children's information and view their activities.</p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {/* My Children - Parent can only see their own */}
            <Card>
              <CardHeader>
              ...
              <CardContent>
                {isLoadingChildren ? (
                  <div className="py-4 text-center">Loading your children...</div>
                ) : children.length === 0 ? (
            ...
            {/* Recent Attendance for My Children */}
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                ...
                {recentAttendance.length === 0 ? (
                  <div className="py-8 text-center">
                    ...
                    <p className="text-muted-foreground">
                      Your children's attendance records will appear here.
                    </p>
                  </div>
                ) : (
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <Button onClick={handleAddChild} className="w-full" variant="outline">
                  <Plus className="mr-2 h-4 w-4" />
                  Add New Child
                </Button>
                ...
                <Button onClick={() => navigate('/events')} className="w-full" variant="outline">
