...
const InstallPWABanner = () => {
    ...
    return (
        <AnimatePresence>
            ...
            >
                <div className="relative group overflow-hidden rounded-[2.5rem] bg-white/40 dark:bg-slate-900/40 backdrop-blur-3xl border border-white/40 dark:border-white/10 shadow-2xl p-6 shadow-indigo-500/10">
                    {/* Background Glow */}
                    ...
                    <div className="flex gap-4 items-center">
                        <div className="h-16 w-16 min-w-[64px] rounded-2xl bg-gradient-to-tr from-indigo-600 to-indigo-400 p-[2px] shadow-lg shadow-indigo-500/20">
                            <div className="h-full w-full rounded-2xl bg-white dark:bg-slate-950 flex items-center justify-center p-2 overflow-hidden">
                    ...
                    <div className="mt-6 flex gap-3">
                        <Button 
                            onClick={installPWA}
                            className="flex-1 h-12 bg-indigo-600 hover:bg-indigo-700 text-white rounded-[1.2rem] font-black italic tracking-widest text-[10px] uppercase shadow-lg shadow-indigo-100"
                        >
                        ...
                        <Button 
                            ...
                            className="h-12 px-6 rounded-[1.2rem] font-black text-[10px] uppercase tracking-widest text-slate-400 hover:text-slate-600"
                        >
                            Later
                        </Button>
                    </div>
