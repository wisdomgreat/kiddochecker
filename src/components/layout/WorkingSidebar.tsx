      ...
      <div className="px-4 py-2 border-b">
        ...
        {userRole === 'admin' && !canAccessParent && (
          <div className="flex items-center gap-2 mt-2 p-2 bg-amber-50 rounded-lg">
            ...
            <span className="text-xs text-amber-700">Admin Mode</span>
          </div>
        )}
      </div>
          ...
          {navigationItems.map((item) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "flex items-center gap-3 rounded-lg px-3 py-2 text-muted-foreground transition-all hover:text-primary w-full text-left hover:bg-muted cursor-pointer",
